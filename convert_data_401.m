...
function [ttyyaccgyro] = process_mpu60xx_accgyro_data(ttyaccgyro_raw)
	...
	ttyyaccgyro = ttyaccgyro_raw(:, 2) / resolution * accscale * g;
	ttyyaccgyro = ttyaccgyro_raw(:, 3) / resolution * accscale * g;
	ttyyaccgyro = ttyaccgyro_raw(:, 4) / resolution * accscale * g;
	ttyyaccgyro = ttyaccgyro_raw(:, 6) / resolution * gyroscale;
	ttyyaccgyro = ttyaccgyro_raw(:, 7) / resolution * gyroscale;
	ttyyaccgyro = ttyaccgyro_raw(:, 8) / resolution * gyroscale;
end
